 ...
 * Clean
 */
gulp.task('clean-dist',      ['html:clean', 'scripts:clean', 'styles:clean', 'fonts:clean', 'vendor:clean', 'skins:clean', 'examples:clean']);
...
gulp.task('dist-css', function(done){
  sequence('styles:clean', 'styles:bootstrap', 'styles:extend', 'styles:site', function(){
    done();
...
gulp.task('dist', function(done){
  sequence('dist-html', 'dist-css', 'dist-js', 'dist-vendor', 'dist-skins', 'dist-fonts', 'dist-examples', function(){
    done();
