...
(function(document, window, $) {
  ...
  (function() {
    var combination_chart = c3.generate({
      ...
      color: {
        pattern: [$.colors("blue-grey", 400), $.colors("blue-grey", 200), $.colors("yellow", 600), $.colors("primary", 600), $.colors("red", 400), $.colors("green", 600)]
      },
      grid: {
        x: {
          show: false
  ...
  (function() {
    var donut_chart = c3.generate({
      ...
      color: {
        pattern: [$.colors("primary", 500), $.colors("blue-grey", 200), $.colors("red", 400)]
      },
      legend: {
        position: 'right'
      },
